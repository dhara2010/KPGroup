        ...
        <div className="w-full flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 mb-12 lg:mb-16">
          ...
          <ScrollReveal variant="3d-unfold" delay={0.5} className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-brand-gradient text-white font-extrabold text-xs md:text-sm shadow-lg shadow-brand-violet/25 border border-white/10">
          ...
          <ScrollReveal variant="3d-unfold" delay={0.7} className="flex flex-col items-start gap-6 max-w-[480px]">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <button
                ...
                className="group inline-flex items-center gap-3 px-7 py-3.5 rounded-full bg-brand-gradient text-white font-bold text-sm tracking-wide shadow-[0_10px_30px_rgba(139,92,246,0.4)] hover:shadow-[0_15px_40px_rgba(139,92,246,0.6)] transition-all duration-300 hover:scale-[1.03] active:scale-[0.98]"
              >
                <span>Explore Ecosystem</span>
                <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-white shadow-md group-hover:translate-x-1 transition-transform">
