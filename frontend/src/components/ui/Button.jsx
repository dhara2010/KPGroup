...
export function Button({ 
  ...
  const variants = {
    ...
    secondary: "bg-bg-soft text-text hover:bg-border border border-border",
    outline: "bg-transparent border-2 border-primary text-primary hover:bg-primary hover:text-white",
    ghost: "bg-transparent text-text-secondary hover:text-primary hover:bg-accent-soft",
    dark: "bg-bg-dark text-white hover:bg-primary",
    light: "bg-bg text-text hover:bg-bg-soft shadow-sm hover:shadow",
    accent: "bg-accent text-white hover:bg-primary shadow-md hover:shadow-lg"
  };
