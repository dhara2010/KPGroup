...
function PortraitCard({ reel, onPlay, className = "" }) {
  ...
  return (
    <div
      className={`relative overflow-hidden cursor-pointer group ${className} border border-slate-200/60 rounded-[2.5rem] bg-slate-900 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-primary/60 hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] transition-all duration-500`}
      onClick={() => onPlay(reel)}
...
function LargeQuoteCard({ reel, className = "" }) {
  return (
    <div className={`relative overflow-hidden flex flex-col justify-between ${className} border border-slate-200/60 rounded-[2.5rem] bg-white/90 backdrop-blur-md p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:border-primary/40 transition-all duration-500`}>
...
function VideoCard({ reel, onPlay, className = "" }) {
  ...
  return (
    <div
      className={`relative overflow-hidden cursor-pointer ${className} border border-slate-200/60 rounded-[2.5rem] bg-slate-900 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-primary/60 hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] transition-all duration-500`}
      onClick={() => onPlay(reel)}
      onMouseEnter={() => setHov(true)}
      onMouseLeave={() => setHov(false)}
    >
...
function SmallQuoteCard({ reel, className = "" }) {
  return (
    <div className={`flex flex-col justify-between overflow-hidden ${className} border border-slate-200/60 rounded-[2.5rem] bg-white/90 backdrop-blur-md p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:border-primary/40 transition-all duration-500`}>
...
function MiniCard({ reel, onPlay, className = "" }) {
  ...
  return (
    <div
      className={`flex gap-4 items-center overflow-hidden cursor-pointer ${className} border border-slate-200/60 rounded-[2.5rem] bg-white/90 backdrop-blur-md p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:border-primary/40 transition-all duration-500`}
      onClick={() => onPlay(reel)}
      onMouseEnter={() => setHov(true)}
      onMouseLeave={() => setHov(false)}
    >
...
export default function TestimonialsPage() {
  ...
  return (
    <main className="min-h-screen bg-transparent text-slate-900 font-sans relative overflow-hidden">
      {/* Removed ambient glows to reveal global cube background */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 my-12 md:my-16">
        <div className="bg-white/90 backdrop-blur-md border border-slate-200/60 rounded-[2.5rem] p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center justify-around flex-wrap gap-6">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="bento-grid">
          ...
          <div className="g-tapti relative overflow-hidden flex flex-col justify-between border border-slate-200/60 rounded-[2.5rem] bg-white/90 backdrop-blur-md p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] hover:border-primary/40 transition-all duration-500">
