  ...
  return (
    <div className="relative bg-white text-slate-900 min-h-screen overflow-hidden font-sans pt-0 pb-20">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-60 z-0">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(108,59,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(108,59,255,0.03)_1px,transparent_1px)] bg-[size:45px_45px]"></div>
