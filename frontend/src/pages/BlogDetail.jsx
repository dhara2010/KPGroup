...
export default function SinglePostPage({ params }) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-transparent flex items-center justify-center pt-24 pb-20">
  ...
  if (error || !post) {
    return (
      <div className="min-h-screen bg-transparent text-slate-900 flex items-center justify-center pt-24 pb-20">
        ...
        <div className="max-w-6xl mx-auto px-6 mt-12 md:mt-16 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden aspect-[16/9] w-full border border-slate-200/60 bg-white/90 backdrop-blur-md p-2 shadow-[0_8px_30px_rgb(0,0,0,0.04)] group/cover">
                ...
                {comments.length > 0 ? (
                  <div className="space-y-4">
                    {comments.map((comment) => (
                      <div 
                        key={comment.id} 
                        className="p-6 bg-white/90 backdrop-blur-md border border-slate-200/60 rounded-[2.5rem] text-xs text-slate-700 relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:border-primary/50 transition-all duration-300"
                      >
                  ...
                  <div className="p-8 text-center bg-white/90 backdrop-blur-md border border-slate-200/60 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              ...
              <div className="bg-white/90 backdrop-blur-md border border-slate-200/60 rounded-[2.5rem] p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden">
                ...
                <form onSubmit={handleCommentSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="group w-full py-4 rounded-full font-black text-white bg-slate-950 hover:bg-brand-violet shadow-md hover:shadow-xl transition-all duration-300 text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-4 active:translate-y-0 hover:-translate-y-0.5 cursor-pointer"
                  >
                    Submit Feedback
            ...
            <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-28">
              ...
              <div className="bg-white/90 backdrop-blur-md border border-slate-200/60 rounded-[2rem] p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                <Link
                  to="/blog"
              ...
              {/* Author Bio Widget */}
              <div className="bg-white/90 backdrop-blur-md border border-slate-200/60 rounded-[2rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden group/author">
              ...
              <div className="bg-white/90 backdrop-blur-md border border-slate-200/60 rounded-[2rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative">
                <h3 className="text-[10px] font-black uppercase tracking-wider text-slate-400 border-b border-slate-100 pb-3 mb-5 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                  SHARE ARTICLE
                </h3>
              ...
              <div className="bg-white/90 backdrop-blur-md border border-slate-200/60 rounded-[2rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                <h3 className="text-[10px] font-black uppercase tracking-wider text-slate-400 border-b border-slate-100 pb-3 mb-5 flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                  METADATA INDEX
                </h3>
