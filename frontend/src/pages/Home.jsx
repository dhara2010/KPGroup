...
import AtAGlanceStats from "@/components/sections/AtAGlanceStats";
import Ecosystem from "@/components/sections/Ecosystem";
import WhyKPGroup from "@/components/sections/WhyKPGroup";
...
export default function Home() {
  return (
    <main className="overflow-x-hidden bg-transparent text-slate-900">
