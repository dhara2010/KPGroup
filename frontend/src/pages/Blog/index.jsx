...
export default function BlogPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden font-sans pt-0 pb-32 bg-slate-50 text-slate-900">
      
      {/* Background Ambience */}
      <div className="absolute inset-0 pointer-events-none z-0 opacity-40">
        <div className="absolute top-[-10%] right-[-5%] w-[50vw] h-[50vw] bg-primary/10 rounded-full blur-[140px]" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 -mt-8 md:-mt-12">
          ...
          <ScrollReveal variant="fade-up">
            <div className="bg-white rounded-2xl md:rounded-full shadow-lg border border-slate-200 p-2 mb-12 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {gridPosts.map((post, idx) => (
                <ScrollReveal key={post.id || idx} variant="fade-up" delay={idx * 0.05}>
                  <Link 
                    to={`/${post.slug}`} 
                    className="group flex flex-col h-full bg-white rounded-3xl overflow-hidden border border-slate-200 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/5 hover:-translate-y-1.5 transition-all duration-500"
                  >
            ...
            <ScrollReveal variant="fade-up">
              <div className="text-center py-24 bg-white border border-slate-200 rounded-3xl shadow-sm">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-slate-900 hover:bg-primary rounded-full text-xs font-bold uppercase tracking-widest text-white transition-all duration-300 shadow-lg"
                >
                  Clear All Filters
                </button>
              </div>
