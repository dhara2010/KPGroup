  ...
  return (
    <section className="relative py-32 bg-[#020202] overflow-hidden font-sans border-t border-[#E2E8F0]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-20">
        <div className="absolute top-1/2 left-0 w-[50vw] h-[50vw] bg-[#064B63]/10 rounded-full blur-[150px]"></div>
      </div>
        ...
        <div className="mb-20 flex flex-col text-center items-center">
          <ScrollReveal variant="3d-unfold">
            <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-[#F7F9FA] border border-[#E2E8F0] mb-6">
              <HelpCircle className="w-4 h-4 text-[#064B63]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <ScrollReveal variant="3d-zoom" delay={0.3} className="lg:col-span-5 flex flex-col items-center justify-center" style={{ transformStyle: "preserve-3d" }}>
            <ThreeDTilt tiltMax={18} glareOpacity={0} scale={1.05} className="w-72 h-72 md:w-96 md:h-96 flex items-center justify-center cursor-pointer" style={{ transformStyle: "preserve-3d" }}>
              <div className="absolute inset-0 rounded-full border border-dashed border-[#E2E8F0] animate-[spin_60s_linear_infinite] flex items-center justify-center" style={{ transform: "translateZ(10px)" }}>
                <div className="w-[85%] h-[85%] rounded-full border border-dashed border-[#E2E8F0] animate-[spin_40s_linear_infinite_reverse]"></div>
              </div>

              <div className="absolute w-48 h-48 bg-[#064B63]/10 rounded-full blur-3xl animate-pulse" style={{ transform: "translateZ(20px)" }}></div>
                ...
                >
                  <div 
                    className={`group rounded-2xl border transition-all duration-300 overflow-hidden ${
                      isOpen 
                        ? 'bg-[#F7F9FA] border-[#064B63]/20 shadow-[0_0_30px_rgba(168,85,247,0.1)]' 
                        : 'bg-white/[0.02] border-[#E2E8F0] hover:border-[#E2E8F0] hover:bg-white/[0.04]'
                    }`}
                  >
                    <button
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <Settings className={`w-5 h-5 transition-all duration-500 shrink-0 ${
                          isOpen ? 'text-[#064B63] rotate-90 scale-110' : 'text-gray-600 group-hover:text-[#475569]'
                        }`} />
                        
                        <span className={`font-semibold tracking-tight text-sm md:text-base transition-colors duration-300 ${
                          isOpen ? 'text-[#111827]' : 'text-[#475569] group-hover:text-[#111827]'
                        }`}>
                          {faq.question}
                        </span>
                      </div>
                      ...
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 border ${
                        isOpen 
                          ? 'bg-purple-500 border-purple-400 text-[#111827] rotate-45 scale-110' 
                          : 'bg-[#F7F9FA] border-[#E2E8F0] text-[#475569] group-hover:border-[#E2E8F0] group-hover:text-[#111827]'
                      }`}>
                    ...
                    >
                      <div className="px-6 pb-6 pt-2 pl-14 text-sm md:text-base text-[#475569] font-light leading-relaxed border-t border-[#E2E8F0]">
                        {faq.answer}
                      </div>
                    </div>
