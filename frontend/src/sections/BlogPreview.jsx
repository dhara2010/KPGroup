...
export default function BlogPreview() {
  ...
  return (
    <Section id="blog-preview" variant="default" className="relative overflow-hidden py-32 bg-slate-50 text-slate-900 border-t border-slate-200/50">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <ScrollReveal variant="fade-up" delay={0.2} className="md:text-right">
            <Link
              to="/blogs"
              className="group inline-flex items-center gap-3 px-6 py-3 rounded-full bg-slate-900 hover:bg-primary text-white font-bold text-xs uppercase tracking-widest transition-all duration-300"
            >
