...
export default function VisionMissionPage() {
    return (
        <section className="relative py-32 bg-bg overflow-hidden font-sans border-t border-border">
            {/* Immersive radial glows */}
            <div className="absolute inset-0 z-0 pointer-events-none opacity-20">
                <div className="absolute top-1/4 right-0 w-[60vw] h-[60vw] bg-primary/5 rounded-full blur-[160px]" />
                <div className="absolute bottom-1/4 left-0 w-[60vw] h-[60vw] bg-primary/5 rounded-full blur-[160px]" />
            </div>
