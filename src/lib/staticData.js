export const staticData = {
  ...
  team: [
    { id: 1, name: "Parth Kanjariya", role: "Founder & CEO", image: "/team/Parth-Kanjariya-Founder-CEO.webp", color: "from-blue-600 to-cyan-400" },
    { id: 2, name: "Nisarg Bhatt", role: "Bussiness Advisor & Stratagic Partner", image: "/team/Nisarg-bhatt.webp", color: "from-cyan-500 to-blue-500" },
    { id: 3, name: "Marvin Mtama", role: "International Clients Handle", image: "/team/Marvin.webp", color: "from-purple-600 to-pink-500" },
    { id: 4, name: "Punit Kanjariya", role: "Head of Ahmedavad", image: "/team/Punit-kanjariya.webp", color: "from-violet-600 to-indigo-500" }
  ],
  blogs: [
    {
      id: 1,
      ...
      comments: [
        { id: 1, author: "A WordPress Commenter", date: "February 24, 2026", content: "Hi, this is a comment." }
      ]
    }
  ]
};
